/**
 * Componente reproductor de audio mejorado
 */
...
export function AudioPlayer() {
  ...
  const handleSkipForward = () => {
    const newPosition = Math.min(audioState.currentPosition + 10, audioState.trackDuration || 0);
    seek(newPosition);
  };
    ...
    <div className="bg-dark-card rounded-xl shadow-2xl p-6 space-y-6">
      ...
      <div className="space-y-2">
        <div className="relative h-2 bg-dark-hover rounded-full overflow-hidden group">
          ...
          <input
            ...
            disabled={!isHost || !audioState.trackDuration}
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <motion.button
          ...
          disabled={!isHost || !audioState.trackUrl}
