...
export function HomePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-primary-50 to-primary-100 dark:from-dark-bg dark:to-dark-surface flex flex-col items-center justify-center p-4">
